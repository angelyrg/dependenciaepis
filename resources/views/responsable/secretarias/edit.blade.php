    ...
    <div class="col-lg-6 offset-lg-3">
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form action="{{route('secretarias.update', $secretaria->id)}}" method="POST" class="row g-3 needs-validation" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="col-md-6">
              ...
              <div class="input-group has-validation">
                ...
                <input type="text" name="nombres" value="@if(!old('nombres')){{$secretaria->nombres}}@else{{old('nombres')}}@endif" class="form-control" id="validationCustom01" required>
            ...
            <div class="col-md-6">
              ...
              <div class="input-group has-validation">
                ...
                <input type="text" name="apellidos" value="@if(!old('apellidos')){{$secretaria->apellidos}}@else{{old('apellidos')}}@endif" class="form-control"  id="validationCustom02"  required>
                <div class="invalid-feedback">
            ...
            <div class="col-md-6">
              ...
              <div class="input-group has-validation">
                ...
                <input type="text" name="dni" value="@if(!old('dni')){{$secretaria->dni}}@else{{old('dni')}}@endif" minlength="8" maxlength="8" class="form-control" required aria-describedby="inputGroupPrepend" onKeypress="if (event.keyCode < 45 || event.keyCode > 57) event.returnValue = false;">  
                <div class="invalid-feedback">
