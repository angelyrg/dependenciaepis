            ...
            <table class="table datatable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <span class="badge bg-@if($asesorado->estado=="Inscrito"){{'secondary'}}@elseif($asesorado->estado=="Inicio"){{'dark'}}@elseif($asesorado->estado=="Parcial"){{'warning'}}@elseif($asesorado->estado=="Completado"){{'success'}}@endif">
                      {{$asesorado->estado}}
                    </span></td>                 
                </tr>
                @endforeach
